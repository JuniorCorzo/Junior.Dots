  ...
  wrappedQuickshell = pkgs.symlinkJoin {
    ...
    postBuild = ''
      wrapProgram $out/bin/qs \
        ...
        --prefix LD_LIBRARY_PATH : "${pkgs.libGL}/lib:${pkgs.mesa}/lib:/usr/lib64:${pkgs.qt6.qtpositioning}/lib:${pkgs.qt6.qt5compat}/lib:${pkgs.qt6.qtdeclarative}/lib:${pkgs.qt6.qtbase}/lib:${pkgs.kdePackages.kirigami}/lib:${pkgs.kdePackages.syntax-highlighting}/lib" \
